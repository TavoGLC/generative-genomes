...
seqsfile = SeqIO.parse("/media/tavo/storage/dengue.fasta", "fasta")
seqs = []
...
model.fit(Xtrain,Xtrain,validation_data=(Xtest,Xtest), 
          batch_size=batchSize, epochs=100)

model.layers[2].save(outputPath+'/testdenv.h5')
