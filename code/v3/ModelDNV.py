...
MetaData = pd.read_csv('/media/tavo/storage/biologicalSequences/genomes/dnv/sequences.csv')
...
seqsfile = SeqIO.parse("/media/tavo/storage/biologicalSequences/genomes/dnv/sequences.fasta", "fasta")
seqs = []
ids = []
