...
MetaData = pd.read_csv('/media/tavo/storage/biologicalSequences/genomes/vhb/sequences.csv')
...
seqsfile = SeqIO.parse("/media/tavo/storage/biologicalSequences/genomes/vhb/sequences.fasta", "fasta")
seqs = []
ids = []
...
encoder = EncoderModel(units=12)
decoder = DecoderModel(units=12)
