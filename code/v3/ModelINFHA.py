...
MetaData = pd.read_csv('/media/tavo/storage/biologicalSequences/genomes/infha/sequences.csv')
...
seqsfile = SeqIO.parse("/media/tavo/storage/biologicalSequences/genomes/infha/sequences.fasta", "fasta")
seqs = []
ids = []
