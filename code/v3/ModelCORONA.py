...
MetaData = pd.read_csv('/media/tavo/storage/biologicalSequences/genomes/corona/sequences.csv')
...
seqsfile = SeqIO.parse("/media/tavo/storage/biologicalSequences/genomes/corona/sequences.fasta", "fasta")
seqs = []
ids = []
