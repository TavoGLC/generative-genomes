...
MetaData = pd.read_csv('/media/tavo/storage/biologicalSequences/genomes/infm2/sequences.csv')
...
seqsfile = SeqIO.parse("/media/tavo/storage/biologicalSequences/genomes/infm2/sequences.fasta", "fasta")
seqs = []
ids = []
