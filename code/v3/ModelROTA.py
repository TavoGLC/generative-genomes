...
MetaData = pd.read_csv('/media/tavo/storage/biologicalSequences/genomes/rota/sequences.csv')
...
seqsfile = SeqIO.parse("/media/tavo/storage/biologicalSequences/genomes/rota/sequences.fasta", "fasta")
seqs = []
ids = []
